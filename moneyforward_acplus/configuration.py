...
class Configuration(object):
    ...
    You can programmatically set the cookie:
      conf = moneyforward_acplus.Configuration(
    ...
    def __init__(self, host="https://api-enterprise-accounting.moneyforward.com/api/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("moneyforward_acplus")
